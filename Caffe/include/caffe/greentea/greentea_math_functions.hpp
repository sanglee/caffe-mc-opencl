...
void greentea_gpu_matrix_axpy(const int_tp ctx_id, const int_tp N, const Dtype alpha,
                       const cl_mem x, const int_tp offx, cl_mem y,
                       const int_tp offy, viennacl::matrix<Dtype> *gpu_matrix);
...
template<typename Dtype>
void greentea_matrix_prox(const int_tp ctx_id, viennacl::matrix<Dtype> *gpu_matrix,
         Dtype lambda);
...
template<typename Dtype>
void compress_gpu_matrix(const int_tp ctx_id,
        viennacl::matrix<Dtype> * org_matrix,
        viennacl::compressed_matrix<Dtype> *csr_matrix);
